...
Current EA on the laptop: **v2.23**. Chart: **BREAK100 M30**. Live locked.
...
Copy `mql5/Experts/Break100 Box Trading.mq5` and `mql5/Include/Break100/*` into each terminal `MQL5` folder. Compile with MetaEditor. **0 errors.** Attach on **BREAK100 M30** only.
...
Copy-Item mql5\Install-Break100-Box-Trading.ps1 mql5-pack\
cd mql5-pack
powershell -ExecutionPolicy Bypass -File .\Install-Break100-Box-Trading.ps1
```
