...
## Current State
- Current version: MQL5 EA v2.31 (Observe/Shadow/Demo_Auto; Live behind four gates, default off); Python side adds an offline research package alongside the earlier safety kernel.
